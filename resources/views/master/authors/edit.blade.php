                    ...
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[150px]">
                            <div class="mt-[20px]">
                                ...
                                <input type="text" name="name" id="name" value="{{$author->name}}" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" {{--onkeydown="clearErrorsImePrezimeAutorEdit()"--}}/>
{{--                                <div id="validateImePrezimeAutorEdit"></div>--}}
                            ...
                            <div class="mt-[20px]">
                                ...
                                <textarea name="about"
                                          rows="6"
                                          class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]">{{$author->about}}</textarea>
                            </div>
                        </div>
                    </div>
