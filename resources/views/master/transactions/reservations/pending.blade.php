...
{{--                                </label>--}}
{{--                            </th>--}}
{{--                            <th class="flex items-center px-4 py-4 leading-4 tracking-wider text-left">Book--}}
{{--                                title<a href="#"><i class="ml-2 fa-lg fas fa-long-arrow-alt-down"--}}
...
{{--                                Date of reservation<i class="ml-2 fas fa-filter"></i>--}}
...
{{--                                <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">TODO</td>--}}
{{--                                <td class="flex flex-row items-center px-4 py-3">--}}
{{--                                    <img class="object-cover w-8 h-8 rounded-full" src="img/profileStudent.jpg"--}}
{{--                                         alt=""/>--}}
{{--                                    <a href="{{ route('students.show', $reservation->student) }}" class="ml-2 font-medium text-center">{{ $reservation->student->name }}</a>--}}
{{--                                </td>--}}
{{--                                <td class="px-4 py-3 changeStatus">--}}
{{--                                    <form method="post" action="{{ route('reservations.accept', $reservation) }}" class="inline">--}}
{{--                                        @csrf--}}
{{--                                        @method('patch')--}}
...
{{--                                        </button>--}}
{{--                                    </form>--}}
{{--                                    <form method="post" action="{{ route('reservations.deny', $reservation) }}" class="inline">--}}
{{--                                        @csrf--}}
{{--                                        @method('patch')--}}
