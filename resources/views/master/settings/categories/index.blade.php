        ...
        <div
            ...
            <table class="overflow-hidden shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]" id="myTable">
                ...
                <tr class="border-b-[1px] border-[#e4dfdf]">
                    ...
                    <th class="px-4 py-4 leading-4 tracking-wider text-left">Name of category<a href="#"><i
                                    ...
                                    <div class="py-1">
                                        <a href="{{route('categories.edit', $category)}}" tabindex="0"
                                           ...
                                           role="menuitem">
                                            ...
                                            <span class="px-4 py-0">Edit a category</span>
                                        </a>
                                        <form action="{{ route('categories.destroy', $category) }}" method="post">
                                           ...
                                           role="menuitem">
                                            ...
                                            <span class="px-4 py-0">Delete a category</span>
                                        </button>
                                        </form>
                                    </div>
                                </div>
