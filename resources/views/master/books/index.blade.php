...
<main class="flex flex-row small:hidden">
    <!-- Content -->
    <section class="w-screen h-screen pl-[15px] py-[1px] text-gray-700">
        <!-- Heading of content -->
                    ...
                    <table class="w-full overflow-hidden shadow-lg rounded-xl" id="myTable">
                        ...
                        <tr class="border-b-[1px] border-[#e4dfdf]">
                            ...
                            <th id="autoriMenu"
                                ...
                                Author<i class="ml-2 fas fa-filter"></i>
                                        ...
                                        <div class="py-1">
                                            ...
                                            <a href="{{route('books.edit', $book)}}}}" tabindex="0"
                                               ...
                                               role="menuitem">
                                                ...
                                                <span class="px-4 py-0">Edit the book</span>
                                            </a>

                                            <a href="{{route('books.destroy', $book)}}" tabindex="0"
                                               class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                               role="menuitem">
                                                <i class="fas fa-level-up-alt mr-[14px] ml-[5px] py-1"></i>
                                                <span class="px-4 py-0">List off the book</span>
                                            </a>
                                            ...
                                            <a href="izdajKnjigu.php" tabindex="0"
                                               ...
                                               role="menuitem">
                                                ...
                                                <span class="px-4 py-0">Rent the book</span>
                                            </a>
                                            ...
                                            <a href="vratiKnjigu.php" tabindex="0"
                                               ...
                                               role="menuitem">
                                                ...
                                                <span class="px-4 py-0">Return the book</span>
                                            </a>
                                            ...
                                            <a href="rezervisiKnjigu.php" tabindex="0"
                                               ...
                                               role="menuitem">
                                                ...
                                                <span class="px-4 py-0">Reserve the book</span>
                                            </a>
