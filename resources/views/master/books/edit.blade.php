...
{{--                                <div id="validateNazivKnjigaEdit"></div>--}}
                            ...
                            <div class="mt-[20px]">
                                <p class="inline-block mb-2">Content(short description)</p>
                                <textarea name="content"
                                          class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]">{{$book->content}}</textarea>
                            </div>

                            <div class="mt-[20px]">
                                <p>Izaberite kategorije <span class="text-red-500">*xxxxxxxxxx</span></p>
                        ...
                        <div class="mt-[20px]">
                            <p>Izaberite zanrove <span class="text-red-500">*xxxxxxxxxx</span></p>
