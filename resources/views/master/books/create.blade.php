        ...
        <section class="w-screen h-screen pl-[15px] py-[1px] text-gray-700">
            ...
            <div class="heading">
                <div class="flex border-b-[1px] border-[#e4dfdf]">
                    <div class="pl-[30px] py-[2px] flex flex-col">
                        <div>
                            <h1>
                                New book
                            </h1>
                          ...
                          {{--  <select  class="form-control m-bot15" name="author_id">
                            ...
                            <div class="w-[50%]">
                                <div class="mt-[20px]">
                                    ...
                                    <select class="flex flex-col w-[90%] flex p-1 my-2 py-2.5 bg-white border border-gray-300 shadow-sm svelte-1l8159u focus-within:ring-2 focus-within:ring-[#576cdf]" id="autori" name="author_id">
                                        @foreach ($authors as $author)
