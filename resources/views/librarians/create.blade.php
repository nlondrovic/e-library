            ...
            <div class="flex flex-row ml-[50px]">
                ...
                <div class="mt-[2px]">
                    ...
                    <img id="image-output-student" width="360" class="mt-[20px] p-2 border-2 border-gray-300"
                         src="{{ asset('/assets/img/user.jpg') }}" alt="{{ __('Librarian image') }}"
