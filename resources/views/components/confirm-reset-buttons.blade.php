<a href="{{ url()->previous() }}"
   ...
   class="btn-animation shadow-lg mr-[15px] focus:outline-none text-sm py-2.5 px-5 transition duration-300 ease-in bg-[#C84636] hover:bg-[#F55549] rounded-[5px]">
...
<button type="submit"
        ...
        class="btn-animation shadow-lg w-[150px] disabled:opacity-50 focus:outline-none text-sm
                                py-2.5 px-5 transition duration-300 ease-in rounded-[5px] hover:bg-[#28B478] bg-[#32C184]">
