    ...
    <div class="height-kategorije pb-[30px]">
        <div class="flex items-center py-[10px] space-x-3 rounded-lg">
            <a href="{{ route('scripts.create') }}"
               ...
               rounded-[5px] tracking-wider text-white bg-[#1d2a4c] rounded hover:bg-[#36454F] shadow-md">
                ...
                @foreach($scripts as $script)
                    <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                        ...
                        <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                            <p class="inline cursor-pointer text-[20px] py-[10px] px-[30px] border-gray-300 dotsFormat hover:text-[#536878]">
                                    ...
                                    <div class="py-1">
                                        <a href="{{ route('scripts.edit', $script) }}" tabindex="0"
                                           class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600">
                                            ...
                                            <span class="px-4 py-0 ml-[5px]">{{ __('Edit script') }}</span>
                                        </a>
