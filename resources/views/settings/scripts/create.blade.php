...
@section('main')
    ...
    <div class="pl-[50px] pb-[5px] border-b-[1px] border-[#e4dfdf] header-breadcrumbs">
        ...
        <a href="{{ route('scripts.create') }}">{{ __('New script') }}</a>
    </div>

    <div class="scroll height-content section-content">
        <form class="text-gray-700 forma pl-[28px]" method="post" action="{{ route('scripts.store') }}" id="not_filter_form">
            @csrf
            @method('post')
