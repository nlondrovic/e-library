...
@section('main-settings')
    ...
    @if(session()->has('flash-category-store-success'))
        <div class="flash_message success">
            <i class="fa-solid fa-check text-[17px] mr-[8px] justify-center"></i>Success!
            <p class="text-left"> {{ session()->get('flash-category-store-success') }} </p>
        </div>
    @elseif(session()->has('flash-category-update-success'))
        <div class="flash_message success">
            <i class="fa-solid fa-check text-[17px] mr-[8px] justify-center"></i>Success!
            <p class="text-left"> {{ session()->get('flash-category-update-success') }} </p>
        </div>
    @endif
