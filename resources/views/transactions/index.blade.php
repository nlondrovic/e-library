                    ...
                    <div class="w-[300px] pl-[32px]">
                        <span class="whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                            <div class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer
                                ...
                                <a href="{{ route('checkouts.index', ['student_ids' => request()->get('student_ids'), 'book_ids' => request()->get('book_ids')]) }}"
                    ...
                    <div class="w-[300px] pl-[32px]">
                        <span class="whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                            <div class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer
                                ...
                                <a href="{{ route('checkins.index', ['student_ids' => request()->get('student_ids'), 'book_ids' => request()->get('book_ids')]) }}"
                                   class="flex items-center">
                    ...
                    <div class="w-[300px] pl-[28px] py-1">
                        <span class=" whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                            <div class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer
                                ...
                                <a href="{{ route('overdue.index', ['student_ids' => request()->get('student_ids'), 'book_ids' => request()->get('book_ids')]) }}"
                                   class="flex items-center">
                    ...
                    <div class="w-[300px] pl-[28px]">
                        <span class=" whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                            <div class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer
                                ...
                                <a href="{{ route('lost.index', ['student_ids' => request()->get('student_ids'), 'book_ids' => request()->get('book_ids')]) }}"
                                   class="flex items-center">
                    ...
                    <div class="w-[300px] pl-[32px]">
                        <span class="whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                            <div class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer
                                ...
                                <a href="{{ route('reservations.active', ['student_ids' => request()->get('student_ids'), 'book_ids' => request()->get('book_ids')]) }}"
                                   class="flex items-center">
                    ...
                    <div class="w-[300px] pl-[32px]">
                        <span class=" whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                            <div class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer
                                ...
                                <a href="{{ route('reservations.archived', ['student_ids' => request()->get('student_ids'), 'book_ids' => request()->get('book_ids')]) }}"
                                   class="flex items-center">
