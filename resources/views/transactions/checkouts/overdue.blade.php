...
@section('title', __('Overdue checkouts'))
...
@section('table')
    ...
    <table class="w-full overflow-hidden shadow-lg rounded-xl" id="myTable">
        ...
        <tr class="border-b-[1px] border-[#e4dfdf]">
            ...
            <th class="px-4 py-4 text-sm leading-4 tracking-wider text-left">{{__('Overdue time')}}</th>
        ...
        @foreach($checkouts as $checkout)
            <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                ...
                <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{ $checkout->getOverdueTime() }}</td>
                <td class="px-6 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                    ...
                    <div
                        ...
                        <div class="absolute right-20 w-56 mt-2 origin-top-right bg-white border
