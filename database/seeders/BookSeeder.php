...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('books')->insert([
            ['title' => 'Romeo i juliA','ISBN' => '123', 'content' => 'Vilijam Šekspir bio je jedan od najvećih pisaca i dramaturga na engleskom jeziku. Ono što ga ?ini velikim piscem i
...
funkcionisanja.'],
            ['title' => 'Bozanstvena Komedija','ISBN' => '456',  'content' => 'Dante je veliki italijanski pesnik, zalagao se za pisanje na narodnom jeziku i bio osniva? strofe od tri stiha, tzv.
...
najve?ih pisaca zbog svog velikog uticaja na kasnije pesnike, kao što su ?oser i Milton.'],
            ['title' => 'Na drini cuprija','ISBN' => '789',  'content' => 'Ivo Andrc? je nesumnjivo jedan od najboljih pisac ikada. ?injenica da je dobio Nobelovu nagradu 1961. godine to potvr?uje,
